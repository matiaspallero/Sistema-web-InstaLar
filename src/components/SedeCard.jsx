    ...
    <div className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden transform hover:-translate-y-1">
      ...
      <div className="p-6 space-y-4">
        ...
        <div className="flex gap-2 pt-4">
          <button 
            onClick={onEdit}
            className="flex-1 bg-blue-50 hover:bg-blue-100 text-blue-600 cursor-pointer py-2 rounded-lg transition-colors flex items-center justify-center gap-2 font-medium"
          >
            <FaEdit /> Editar
          </button>
          <button 
            onClick={onDelete}
            className="flex-1 bg-red-50 hover:bg-red-100 text-red-600 cursor-pointer py-2 rounded-lg transition-colors flex items-center justify-center gap-2 font-medium"
          >
            <FaTrash /> Eliminar
          </button>
        </div>
